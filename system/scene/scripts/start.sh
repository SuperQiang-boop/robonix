...
exec docker run --rm \
    ...
    -e SCENE_DETECT_PERIOD_S="${SCENE_DETECT_PERIOD_S:-3.0}" \
    -e SCENE_CG_OBJ_MAX_POINTS="${SCENE_CG_OBJ_MAX_POINTS:-1500}" \
    -e SCENE_CG_MERGE_THRESHOLD="${SCENE_CG_MERGE_THRESHOLD:-0.55}" \
    -e SCENE_OBJECT_WATCHDOG="${SCENE_OBJECT_WATCHDOG:-0}" \
